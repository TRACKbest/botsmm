...
class SMMBot:
    ...
    def load_accounts(self):
        """Charge les comptes Telegram et Instagram"""
        try:
            # Charger les comptes Telegram
            self.telegram_accounts = self.account_manager.accounts
            ...
            logging.info(f"Comptes chargés: {len(self.telegram_accounts)} Telegram, {len(self.instagram_accounts)} Instagram")
        except Exception as e:
            logging.error(f"Erreur lors du chargement des comptes: {e}")
            self.telegram_accounts = {}
            self.instagram_accounts = {}
    ...
    def add_instagram_account(self, username: str, password: str):
        ...
        try:
            ...
            if username in self.instagram_accounts:
                print(f"{Fore.YELLOW}⚠️ Ce compte Instagram existe déjà{Style.RESET_ALL}")
                return False
            ...
            print(f"{Fore.RED}✗ Erreur lors de l'ajout du compte Instagram{Style.RESET_ALL}")
            return False
    ...
    def remove_instagram_account(self, username: str):
        ...
        try:
            if username in self.instagram_accounts:
                ...
                print(f"{Fore.YELLOW}⚠️ Compte Instagram non trouvé{Style.RESET_ALL}")
                return False
        except Exception as e:
    ...
    def list_instagram_accounts(self):
        ...
        if not self.instagram_accounts:
            print(f"{Fore.YELLOW}Aucun compte Instagram enregistré{Style.RESET_ALL}")
            return
